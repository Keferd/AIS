...
engine = get_engine(db_url="mysql+pymysql://usr:qwerty@192.168.56.104/oruzdb?charset=utf8",db_sync='true')#db_config['database_url'], db_sync=db_config['database_sync'])
